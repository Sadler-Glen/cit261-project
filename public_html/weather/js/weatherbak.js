...
function writeData(data) {
    ...
    htmlString = "Current Weather for <h1>" + cityName + ", " + countryName + "</h1><br />" +
            "Weather: &#09;" + data.weather[0].main + "<br />" +
            "Description: <h1><img src='http://openweathermap.org/img/w/" + data.weather[0].icon +".png'>" + data.weather[0].description + "</h1><br />" +
            "Temperature: <h1>" + data.main.temp + "&degC" + "</h1><br />" +
            "Pressure: " + data.main.pressure + "hPa" + "<br />" +
            "Humidity: " + data.main.humidity +"%" + "<br/>" +
            "Min. Temp: "+ data.main.temp_min +"&degC" + "<br/>" +
            "Max. Temp: "+ data.main.temp_max +"&degC" + "<br/>" +
